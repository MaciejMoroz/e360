...
const TariffPage = ({ products, isLoading, isError, fetchProductsWithRedux, changeLanguage, fetchCurrencysWithRedux, isErrorCurrency, isLoadingCurrency, euroExchangeRate }) => {
    useEffect(() => {
        changeLanguage("EN");
